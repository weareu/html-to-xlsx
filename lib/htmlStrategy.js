...
module.exports = function(options, html, id, cb) {
    ...
    return inlineCss(html, { 
        ...
        applyHeightAttributes: true, applyAttributesTableElements: true,
        preserveFontFaces: true, preserveMediaQueries: true,
        applyTableAttributes: true, removeLinkTags: true,
        removeStyleTags: true, applyLinkTags: true,
        removeHtmlSelectors: true,
        url: options.baseUrl || '/', extraCss: options.extraCss
    })
    .then(function(html) {  
